...
class TicketDetailMobilePage extends StatefulWidget {
  Ticket ticket;
  TicketDetailMobilePage({Key? key, required this.ticket}) : super(key: key);

  final state = _TicketDetailMobilePage();
...
class _TicketDetailMobilePage extends State<TicketDetailMobilePage> {
